...
from ModelBase import ModelCandidate, ModelBase
...
class ModelSelection(ModelBase):
    ...
    def model_testing(self):
        ...
        if self.verbose:
            ...
            for c in self.candidates:
                ModelSelection.display_training_result(c)
    ...
    def bc(self):
        for ne in [10, 20]:
            ...
            self.candidates.append(ModelCandidate(bc, auc, "estimators={}, {}".format(ne, "GBC"), False))
